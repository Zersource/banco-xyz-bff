package com.duoc.bffcajero.auth;
...
/**
 * Valida los JWT emitidos por bff-web. bff-cajero no emite tokens
 * propios, solo verifica la firma con la misma llave HMAC (jwt.secreto,
 * compartida via config-server) y extrae el canal.
 */
@Service
